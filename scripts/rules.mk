...
firmware: $(OUT_PATH) $(OBJ_PATH) $(OBJS) $(WIFI_LIBS) $(PSM_LIBS) $(WIFILMAC_LIBS) $(ALIYUN_SDK_LIBS)
#	@echo "Link Script : $(LD_FILE)"
	@echo "Linking $(OUT_PATH)/$(type)/$(TARGET)/$(OUTPUT).elf"
	@$(CC) $(LFLAGS) -Wl,--whole-archive $(WIFI_LIBS) $(PSM_LIBS) $(WIFILMAC_LIBS) $(ALIYUN_SDK_LIBS) -Wl,--no-whole-archive $(OBJS) -o $(OUT_PATH)/$(type)/$(TARGET)/$(OUTPUT).elf
...
firmware: $(OUT_PATH) $(OBJ_PATH) $(OBJS) $(WIFI_LIBS) $(PSM_LIBS) $(WIFILMAC_LIBS) $(ALIYUN_SDK_LIBS)
	...
	@$(CC) $(LFLAGS) -T$(LD_FILE)  -Wl,--whole-archive $(WIFI_LIBS) $(PSM_LIBS) $(WIFILMAC_LIBS) $(ALIYUN_SDK_LIBS) -Wl,--no-whole-archive $(OBJS) -o $(OUT_PATH)/$(type)/$(TARGET)/$(OUTPUT)_1.elf
...
clean:
	...
	@echo clean all
mklib:
	@nds32le-elf-ar -r $(AKEETA_LIB) $(AKEETA_OBJ)
#// --------------------------------------------------
