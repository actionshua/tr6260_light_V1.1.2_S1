...
static void system_event_msgcall_reg()
{
    EVENT_CALLBACK_REGISTER(SYSTEM_EVENT_STA_CONNECTED, system_event_sta_connected_call);
    EVENT_CALLBACK_REGISTER(SYSTEM_EVENT_STA_DISCONNECTED, system_event_sta_connected_call);
}
