...
#define IR_STOP_HIGH_LEVEL_MAX				44000   	//13.59ms
...
void hal_ir_data_process(void *pvParameters)
{
	...
	//	system_printf(" custom_value = 0x%x, data_value =0x%x \n",(infor_value & 0xffff),(infor_value>>16));
		if((infor_value & 0xffff) == COSTOM_CODE_HBS838)
		{
			...
			{
				case IR_KEY_1:
					system_printf("the key is 1-1\n");
					break;
				
				case IR_KEY_2:
					system_printf("the key is 1-2\n");
					break;
				
				case IR_KEY_3:
					system_printf("the key is 1-3\n");
					break;
				
				case IR_KEY_4:
					system_printf("the key is 1-4\n");
					break;
				
				case IR_KEY_5:
					system_printf("the key is 2-1\n");
					break;
				
				case IR_KEY_6:
					system_printf("the key is 2-2\n");
					break;
				
				case IR_KEY_7:
					system_printf("the key is 2-3\n");
					break;
				
				case IR_KEY_8:
					system_printf("the key is 2-4\n");
					break;
				
				case IR_KEY_9:
					system_printf("the key is 3-1\n");
					break;
				
				case IR_KEY_10:
					system_printf("the key is 3-2\n");
					break;
				
				case IR_KEY_11:
					system_printf("the key is 3-3\n");
					break;
				
				case IR_KEY_12:
					system_printf("the key is 3-4\n");
					break;
				
				case IR_KEY_13:
					system_printf("the key is 4-1\n");
					break;
				
				case IR_KEY_14:
					system_printf("the key is 4-2\n");
					break;
				
				case IR_KEY_15:
					system_printf("the key is 4-3\n");
					break;
				
				case IR_KEY_16:
					system_printf("the key is 4-4\n");
					break;
				
				case IR_KEY_17:
					system_printf("the key is 5-1\n");
					break;
				
				case IR_KEY_18:
					system_printf("the key is 5-2\n");
					break;
				
				case IR_KEY_19:
					system_printf("the key is 5-3\n");
					break;
				
				case IR_KEY_20:
					system_printf("the key is 5-4\n");
					break;
				
				case IR_KEY_21:
					system_printf("the key is 6-1\n");
					break;
				
				case IR_KEY_22:
					system_printf("the key is 6-2\n");
					break;
				
				case IR_KEY_23:
					system_printf("the key is 6-3\n");
					break;
				
				case IR_KEY_24:
					system_printf("the key is 6-4\n");
					break;
				default:
