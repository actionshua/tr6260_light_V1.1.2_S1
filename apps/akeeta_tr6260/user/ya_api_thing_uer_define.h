...
typedef void (*ya_thing_handle_router_status)(ya_router_status_t ya_app_router_status, void *data);

extern void ya_thing_handle_router_status_callback(ya_router_status_t ya_app_router_status, void *data);
