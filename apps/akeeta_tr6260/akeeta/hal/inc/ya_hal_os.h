 ...
 * @return ticks
 */
extern uint64_t ya_hal_os_tickcount_get(void);
 ...
 * @return ticks
 */
extern uint64_t ya_hal_os_msec_to_ticks(uint32_t msecs);
 ...
 * @return mili-seconds
 */
extern uint64_t ya_hal_os_ticks_to_msec(void);
...
extern void ya_hal_os_init_sema(ya_hal_os_mutex_t *mhandle, uint32_t init_val);

extern void ya_hal_os_up_sema(ya_hal_os_mutex_t *mhandle);

extern void ya_hal_os_up_sema_from_isr(ya_hal_os_mutex_t *mhandle);

extern uint32_t ya_hal_os_down_sema(ya_hal_os_mutex_t *mhandle, uint32_t timeout);
