...
/**
 * @brief This function is used to close wifi.
 *
 * @return success: 0, faile: -1
 */
...
/**
 * @brief This function is used to disconnect the router in station mode
 *
 * @return success: 0, faile: -1
 */
...
/**
 * @brief This function is used to set wifi to ap mode.
 *
...
/**
 * @brief This function is used to stop ap and set the wifi to station mode
 *
 * @return success: 0, faile: -1
 */
...
/**
 * @brief This function is used to set the wifi to station mode
 *
 * @return success: 0, faile: -1
 */
...
/**
 * @brief This function is used to get the wifi module mac address
 *
...
/**
 * @brief This function is used to get the wifi ip address in station mode.
 *
...
/**
 * @brief This function is used to get the router gateway ip address in station mode.
 *
...
/**
 * @brief This function is used to get rssi when the sta has connected to router
 *
...
/**
 * @brief This function is used to get the current channel in sta mode.
 *
...
/**
 * @brief This function is used to set the channel in sta mode
 *
...
/**
 * @brief This function is used to scan the obj ssid
 *
 * @return success: 0, faile: -1
 */
...
/* smart config */
typedef void (*ya_monitor_data_cb_t)(uint8_t *data, int len);

/**
 * @brief This function is used to set module into monitor state.
 *
 * @return success: 0, faile: -1
 */
extern int ya_wifi_start_monitor(ya_monitor_data_cb_t fn);

/**
 * @brief This function is used to stop monitor.
 *
 * @return success: 0, faile: -1
 */
extern int ya_wifi_stop_monitor(void);
