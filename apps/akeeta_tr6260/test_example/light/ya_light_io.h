...
typedef struct{
	...
	ya_cloud_light_data_t  ya_cloud_light;
}ya_save_light_data_t;
...
extern void ya_pwm_led_write(unsigned char r,unsigned char g,unsigned char b,unsigned char c,unsigned char w);

extern void ya_write_light_para(ya_light_data_t ya_ligth_para);

extern void ya_light_control_pwm_para_init(void);
