...
#WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/rsn_supp/peerkey.c
...
NEED_AES_WRAP=y
NEED_AES_OMAC1=y
WPA_SUPP_CSRCS += wpas_kay.c
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/pae/ieee802_1x_cp.c
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/pae/ieee802_1x_kay.c
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/pae/ieee802_1x_key.c
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/pae/ieee802_1x_secy_ops.c
endif
...
ifdef CONFIG_IEEE80211R
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/ap/wpa_auth_ft.c
endif
ifdef CONFIG_PEERKEY
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/ap/peerkey_auth.c
endif
endif
...
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/crypto/crypto_gnutls.c
WPA_SUPP_CSRCS_p += $(WPA_SUPP_ROOT)/src/crypto/crypto_gnutls.c
WPA_SUPP_CSRCS_priv += $(WPA_SUPP_ROOT)/src/crypto/crypto_gnutls.c
ifdef NEED_FIPS186_2_PRF
...
WPA_SUPP_CSRCS += wpa_supplicant.c events.c wpas_glue.c scan.c
