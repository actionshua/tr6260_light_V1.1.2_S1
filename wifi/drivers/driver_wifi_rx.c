...
static void nrc_mgmt_deauth_event_sta_rx(struct nrc_wpa_if* intf, struct ieee80211_mgmt *mgmt,
						uint16_t len)
{
	union wpa_event_data event;
	os_memset(&event, 0, sizeof(event));
...
static void nrc_mgmt_disassoc_sta_rx(struct nrc_wpa_if* intf, struct ieee80211_mgmt *mgmt,
						uint16_t len)
{
	union wpa_event_data event;
	os_memset(&event, 0, sizeof(event));
...
static void nrc_mgmt_action_rx(struct ieee80211_mgmt* mgmt, struct nrc_wpa_if* intf)
{
