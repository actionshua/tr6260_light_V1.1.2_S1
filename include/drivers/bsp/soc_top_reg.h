...
#define CLK_ENABLE(x)	      ((*((volatile unsigned int *)CLK_EN_BASE)) = (unsigned int)((*((volatile unsigned int *)CLK_EN_BASE))|(x)))
#define CLK_DISABLE(x)	      ((*((volatile unsigned int *)CLK_EN_BASE)) = (unsigned int)((*((volatile unsigned int *)CLK_EN_BASE))&(~(x))))
