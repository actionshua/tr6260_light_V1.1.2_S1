...
#define NRC6111
#if (defined AMT)||(defined _USR_LMAC_TEST)||(defined SINGLE_BOARD_VER)
typedef struct Stphy_amt_tx_test
{
	uint8_t  	bw;/*0:20M 1:40M*/
	uint8_t  	format;
	uint8_t  	mcs;
	uint32_t 	txgain;
	uint32_t 	ch;
...
typedef struct Stphy_amt_rx_test
{
	uint32_t 	rec_count;/*write 0x00900358 0x10 read 0x009004B8 4*/
	uint32_t 	sync_done_count;/*read 0x00A040D0 4*/
	uint32_t 	cor_sensing_count;/*read 0x00A040B8 4*/
	uint32_t 	sat_sensing_count;/*read 0x00A040C0 4*/
	uint32_t 	lsig_count;/*read 0x00A040F0 4 (11g)*/
	uint32_t 	ht_sig_count;/*read 0x00A04100 4 (11n)*/
	uint32_t 	f11b_count;/*read 0x00A040E8 4    (11b)*/
	uint32_t 	ack_count;/*write 0x00900358 0x11 read 0x009004B8 4*/
}ST_phy_amt_rx;
typedef struct Stphy_amt_tx_pkt_rcd
{
	uint32_t tx_count;
	uint32_t tx_success;
}ST_phy_amt_pkt_tx;
ST_phy_amt_pkt_tx phy_amt_tx_pkt_rcd(bool start_flag/*0:stop 1:start*/);
...
void phy_set_cfo2sfo_factor(uint32_t);
...
uint32_t phy_txpower_cal(int32_t txpower_step,uint8_t format/*11b:FORMAT_11B,11g:FORMAT_11AG 11n:FORMAT_HT_MIXED*/,int step);
enum {
    ///========================================================
    ///
...
#ifndef TS8266_ASIC
	// 2. TX DFE INT
	PHY_REG_TX_DFE_INT		= PHY_REG_BASE_START + 0x3000,
#endif
...
#ifndef TS8266_ASIC
	PHY_REG_TX_DFE_CAL_EN											   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 0 ,
	PHY_REG_TX_DFE_DAC_EN											   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 1 ,
	PHY_REG_TXDAC_CTRL												   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 2 ,
	PHY_REG_ADC_EN													   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 3 ,
	PHY_REG_RXADC_CTRL												   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 4 ,
	PHY_REG_ADC_DCCOMP_I											   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 5 ,
	PHY_REG_ADC_DCCOMP_Q											   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 6 ,
	PHY_REG_ENTRX_MANUAL_MODE										   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 7 ,
	PHY_REG_ENTRX_MANUAL_CFG										   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 8 ,
	PHY_REG_TXON_DELAY												   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 9 ,
	PHY_REG_TXOFF_DELAY 											   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 10 ,
	PHY_REG_TRXGAIN_MANUAL_MODE 									   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 11 ,
	PHY_REG_TRX_MANUAL_GAIN 										   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 12 ,
	PHY_REG_TXGAINSET_DELAY 										   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 13 ,
	PHY_REG_RXGAINSET_DELAY 										   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 14 ,
			
	PHY_REG_ADCEST_EN												   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 15 ,
	PHY_REG_DCEST_I 												   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 16 ,
	PHY_REG_DCEST_Q 												   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 17 ,
	PHY_REG_ADC_ABSMEAN_I											   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 18 ,
	PHY_REG_ADC_ABSMEAN_Q											   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 19 ,
	PHY_REG_ADC_DCEST_IDX											   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 20 ,
	PHY_REG_ENTRX_INV												   = PHY_REG_TX_DFE_INT    + PHY_REG_SIZE * 21 ,
#endif
...
//#endif
    ...
    // 3. RX DFE
    // CTRL
    PHY_REG_RX_DFE_CTRL_THRD_OFDM_CCA     							   = PHY_REG_RX_DFE_CTRL   + PHY_REG_SIZE * 0  ,
    PHY_REG_RX_DFE_CTRL_THRD_DSSS_CCA     							   = PHY_REG_RX_DFE_CTRL   + PHY_REG_SIZE * 1  ,
    PHY_REG_RX_DFE_CTRL_THRD_ANY_CCA     							   = PHY_REG_RX_DFE_CTRL   + PHY_REG_SIZE * 2  ,
	...
	PHY_REG_RX_DFE_AGC_H_PRD										  = PHY_REG_RX_DFE_AGC	  + PHY_REG_SIZE * 6  ,
	PHY_REG_RX_DFE_AGC_F_PRD 										  = PHY_REG_RX_DFE_AGC	  + PHY_REG_SIZE * 7  ,
	PHY_REG_RX_DFE_AGC_LNA_init										  = PHY_REG_RX_DFE_AGC	  + PHY_REG_SIZE * 8  ,
	PHY_REG_RX_DFE_AGC_TIA_init										  = PHY_REG_RX_DFE_AGC	  + PHY_REG_SIZE * 9  ,
	PHY_REG_RX_DFE_AGC_BQ1_init										  = PHY_REG_RX_DFE_AGC	  + PHY_REG_SIZE * 10 ,
	PHY_REG_RX_DFE_AGC_BQ2_init										  = PHY_REG_RX_DFE_AGC	  + PHY_REG_SIZE * 11 ,
    ...
    PHY_REG_RX_DFE_AGC_TIA_GAIN3                                       = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 97 ,
    PHY_REG_RX_DFE_AGC_BQ1_GAIN0                                       = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 98 ,
    PHY_REG_RX_DFE_AGC_BQ1_GAIN1                                       = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 99 ,
    PHY_REG_RX_DFE_AGC_BQ1_GAIN2                                       = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 100,
    PHY_REG_RX_DFE_AGC_BQ1_GAIN3                                       = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 101,
    PHY_REG_RX_DFE_AGC_BQ2_GAIN0                                       = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 102,
    PHY_REG_RX_DFE_AGC_BQ2_GAIN1                                       = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 103,
	PHY_REG_RX_DFE_AGC_BQ2_GAIN2									   = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 104,
	PHY_REG_RX_DFE_AGC_BQ2_GAIN3									   = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 105,
	PHY_REG_RX_DFE_AGC_LNA_GAIN0									   = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 13,
	PHY_REG_RX_DFE_AGC_LNA_GAIN1									   = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 12,
	PHY_REG_RX_DFE_AGC_LNA_GAIN2									   = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 107,
	PHY_REG_RX_DFE_AGC_LNA_GAIN3									   = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 106,

    PHY_REG_RX_DFE_AGC_TOTAL_GAIN									   = PHY_REG_RX_DFE_AGC    + PHY_REG_SIZE * 108,
    ...
    PHY_REG_RX_DFE_SYNC_THR                                            = PHY_REG_RX_DFE_SYNC_CFO + PHY_REG_SIZE * 0  ,
    PHY_REG_RX_DFE_SYNC_WAIT                                           = PHY_REG_RX_DFE_SYNC_CFO + PHY_REG_SIZE * 1  ,
    ...
    PHY_REG_RX_DFE_SYNC_FILTER_DLY                                     = PHY_REG_RX_DFE_SYNC_CFO + PHY_REG_SIZE * 4  ,
    PHY_REG_RX_DFE_SYNC_CFO_EST                                        = PHY_REG_RX_DFE_SYNC_CFO + PHY_REG_SIZE * 5  ,
    ...
    // 4. TOP
    PHY_REG_TOP_PSCM_PHY_VER0                                          = PHY_REG_TOP           + PHY_REG_SIZE * 0 ,
    PHY_REG_TOP_PSCM_PHY_VER1                                          = PHY_REG_TOP           + PHY_REG_SIZE * 1 ,
...
//-------------------------------------------------------------------------------------------------------------------------------,
    ...
    PHY_REG_TOP_PHY_STATE_TIMER                                        = PHY_REG_TOP           + PHY_REG_SIZE * 129,

    PHY_REG_TOP_RXDBE_STATE                                            = PHY_REG_TOP           + PHY_REG_SIZE * 320,

    PHY_REG_TOP_RX_PROT_OPT                                            = PHY_REG_TOP		   + PHY_REG_SIZE * 328,
    PHY_REG_TOP_RX_PROT_EN                                             = PHY_REG_TOP		   + PHY_REG_SIZE * 329,
...
void hal_lmac_set_ldobuck_nv(void);
extern int  amt_nv_read(unsigned int addr, unsigned char * buf, unsigned int len);
extern unsigned int hal_efuse_read(int  addr);
void phy_status_counter_for_n();
#endif //__NRC_PHY_H__
