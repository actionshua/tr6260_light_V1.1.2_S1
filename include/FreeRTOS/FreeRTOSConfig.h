...
#define configTIMER_QUEUE_LENGTH			40	/* Command Queue of daemon task */
...
/* The Priority for net80211 */
//#define NRC_TASK_WLAN_PRIORITY	( configMAX_PRIORITIES -1 )
#define NRC_TASK_WLAN_PRIORITY	( configMAX_PRIORITIES -9 )
//#define NET80211_TASK_STACK_SIZE_DEFAUILT (2048 / sizeof(StackType_t))
#define NET80211_TASK_STACK_SIZE_DEFAUILT (4096 / sizeof(StackType_t) )
#define NET80211_TASK_PRIORITY_DEFAUILT (configMAX_PRIORITIES- 3)
